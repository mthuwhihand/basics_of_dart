...
class AuthLoginFailureInvalidEmail extends AuthLoginFailure {
  const AuthLoginFailureInvalidEmail()
      : super('Email must be in the correct email format.');
}

class AuthLoginFailureInvalidPassword extends AuthLoginFailure {
  const AuthLoginFailureInvalidPassword()
      : super('Passwords must be at least 6 characters long, '
